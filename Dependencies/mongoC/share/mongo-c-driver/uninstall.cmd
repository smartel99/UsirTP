...
cd ..
echo Removing top-level installation directory: C:\Mongo\msvc2017x64\
(rmdir C:\Mongo\msvc2017x64\ 2>NUL) || echo ... not removed (probably not empty)
